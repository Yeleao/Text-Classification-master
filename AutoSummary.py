...
def auto_summary(doc, title, extract_num=None, title_common=False, use_mmr=True):
    ...
    color_list = ['firebrick', 'palevioletred', 'darkorchid', 'violet', 'chocolate', 'sandybrown', 'antuquewhite', 'darkkhaki',
    ...
    feature_df = pd.DataFrame(
        {k: v for v, k in zip([score, pagerank_score, entities_score, title_sim_score, position_score, clue_score, sentences],
                              ['score', 'pagerank_score', 'entities_score', 'title_sim_score', 'position_score', 'clue_score',
                               'sentences'])}
        )
