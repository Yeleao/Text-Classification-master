...
def Bart(textb):
    ...
    model, list_en, list_de = create_student_by_copying_alternating_layers(model, 'train.pth', 12, 3)
    model.load_state_dict(torch.load('E:\Graduate\Codes\Text-Classification\Model\BART.pth', map_location='cpu'))
    outputs, output_str = generate_summary(textb, model)
    print(outputs)
    print(output_str)
